...
function criaLista(){
    ...
    for(let i=0; i<= (dadosLista.length -1); i++){
        tabela+="<tr><th>"+ dadosLista[i] + "</ td><td><button class='btn btn-warning' onclick=''>Editar</button><button class='btn btn-danger'onclick='excluir(this.parentNode.parentNode.rowIndex)'>Excluir</button></td></tr>";
        document.getElementById('tabela').innerHTM = tabela;
    }
}
